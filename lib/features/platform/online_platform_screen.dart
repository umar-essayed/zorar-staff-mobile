              ...
              children: [
                ...
                if (years.isNotEmpty)
                  DropdownButtonFormField<String>(
                    ...
                    items: years.map((y) => DropdownMenuItem(value: y['id']?.toString(), child: Text(y['name']?.toString() ?? '', style: GoogleFonts.cairo(fontSize: 13)))).toList(),
                ...
                if (subjects.isNotEmpty)
                  DropdownButtonFormField<String>(
                    ...
                    items: subjects.map((s) => DropdownMenuItem(value: s['id']?.toString(), child: Text(s['name']?.toString() ?? '', style: GoogleFonts.cairo(fontSize: 13)))).toList(),
